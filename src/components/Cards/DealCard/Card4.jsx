...
function BookingCard(props) {
    ...
    return (
        <Card className="w-full min-w-[20rem] max-w-[20rem] shadow-lg hover:scale-105 duration-500" >
            ...
            <CardBody>
                ...
                <div className="flex items-center justify-between">
                    <span className="text-3xl font-bold text-gray-900 dark:text-white">{props.status}</span>
                </div>
