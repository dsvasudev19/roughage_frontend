...
const Poster=()=>{
    return (
        <div className='block md:flex justify-center gap-3 rounded-xl mt-5'>
            <div id='carouselDiv' className='bg-red-300 h-[50vh] md:h-[60vh] w-[100%] md:w-[60%] mb-3 md:mt-0 rounded-xl'>

                <Carousel /> 
            </div>
            <div id='twoSmallDivs' className='h-[50vh] md:h-[60vh] w-[100%] md:w-[40%] rounded-xl'>
